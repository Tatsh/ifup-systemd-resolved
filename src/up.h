 ...
 * names. Each domain will be added as a LinkDomains object with the second field set to false.
 *
 * @return A unique pointer to a LinkDomainsList containing the domains.
 */
 ...
 *
 * This function retrieves the domains from the environment variable `DNSSEC`. If the value is
